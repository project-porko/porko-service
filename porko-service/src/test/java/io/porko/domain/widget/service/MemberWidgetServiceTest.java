...
import io.porko.domain.widget.controller.WidgetControllerTestHelper;
...
class MemberWidgetServiceTest extends ServiceTestBase {
    ...
    void reorderWidget() {
        ...
        given(widgetService.loadAllWidgets()).willReturn(WidgetControllerTestHelper.allWidgets);
    ...
    void loadOrderedMemberWidgets() {
        ...
        assertThat(actual.unorderedMemberWidgets()).hasSize(WidgetControllerTestHelper.allWidgets.size() - ORDERED_WIDGET_COUNT);
    ...
    private static List<MemberWidget> getMemberWidgets() {
        ...
        List<Widget> widgets = WidgetControllerTestHelper.allWidgets.toWidgets();
