package io.porko.domain.budget.service;

import io.porko.domain.budget.controller.model.BudgetRequest;
import io.porko.domain.budget.controller.model.BudgetResponse;
import io.porko.domain.budget.controller.model.ManageBudgetResponse;
import io.porko.domain.budget.domain.Budget;
import io.porko.domain.budget.exception.BudgetErrorCode;
import io.porko.domain.budget.exception.BudgetException;
import io.porko.domain.budget.repo.BudgetRepo;
...
public class BudgetService {
    ...
    public BudgetResponse getBudget(Integer goalYear, Integer goalMonth, Long memberId) {
        Budget budget = budgetRepo.findByGoalYearAndGoalMonthAndMemberId(goalYear, goalMonth, memberId).orElseThrow(() -> new BudgetException(
            BudgetErrorCode.BUDGET_NOT_SET, goalYear, goalMonth, memberId));
